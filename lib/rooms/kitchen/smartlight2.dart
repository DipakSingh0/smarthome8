...
void main() {
  runApp(
    const MaterialApp(
      home: SmartLight2Page(),
    ),
  );
}

class SmartLight2Page extends StatefulWidget {
  const SmartLight2Page({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SmartLight2PageState createState() => _SmartLight2PageState();
}

class _SmartLight2PageState extends State<SmartLight2Page> {
