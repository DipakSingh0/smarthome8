...
void main() {
  runApp(
    const MaterialApp(
      home: SmartLight1Page(),
    ),
  );
}

class SmartLight1Page extends StatefulWidget {
  const SmartLight1Page({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SmartLight1PageState createState() => _SmartLight1PageState();
}

class _SmartLight1PageState extends State<SmartLight1Page> {
